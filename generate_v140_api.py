...
Also see, http://w3.energistics.org/schema/witsml_v1.4.0_api/index.html and
http://w3.energistics.org/schema/witsml_v1.4.0_api/doc/schema/obj_capClient.xsc for the schema.
"""
